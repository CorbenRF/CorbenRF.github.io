        ...
        <form class="filter__form form" action="#" method="get">
          <fieldset class="form__block">
            ...
            <label class="form__label form__label--price">
              <input class="form__input" type="text" name="min-price" :value="priceFrom" @input="$emit('update:priceFrom', $event.target.value)">
              <span class="form__value">От</span>
            </label>
            <label class="form__label form__label--price">
              <input class="form__input" type="text" name="max-price" :value="priceTo" @input="$emit('update:priceTo', $event.target.value)">
          ...
          <fieldset class="form__block">
            ...
            <label class="form__label form__label--select">
              <select class="form__select" type="text" name="category" :value="categoryId" @change="$emit('update:categoryId', $event.target.value)">
